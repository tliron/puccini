    ...
    AnnotatedT: Annotated + Clone + Default,
{
    ...
    {
        Ok(self.schema(schema_key, definition, source_id, catalog)?.and_then(|schema| schema.into_validation()))
    }
        ...
        SchemaDetailsT: SchemaDetails<AnnotatedT>,
    {
        ...
        self.initialize_schema(schema_key, &mut schema, definition, source_id, catalog)?;
        ...
        SchemaDetailsT: SchemaDetails<AnnotatedT>,
    {
        ...
        let reference = match self.data_kind {
            ...
            None => {
                ...
                return Err(MalformedError::new(DATA_TYPE_NAME.into(), "undetermined data kind".into())
