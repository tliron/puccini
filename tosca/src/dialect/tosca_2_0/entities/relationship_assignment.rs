    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    fn complete(
        ...
        complete_map_for_field!(properties, self, relationship_definition, catalog, source_id, errors);
        complete_map_for_field!(attributes, self, relationship_definition, catalog, source_id, errors);
        complete_map_for_field!(interfaces, self, relationship_definition, catalog, source_id, errors);
