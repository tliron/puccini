    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    fn complete(
        ...
        complete_map!(properties, self, relationship_type, catalog, source_id, errors);
        complete_map!(properties, self, parent, catalog, source_id, errors);
        complete_map!(attributes, self, relationship_type, catalog, source_id, errors);
        complete_map!(attributes, self, parent, catalog, source_id, errors);
        complete_map!(interfaces, self, relationship_type, catalog, source_id, errors);
        complete_map!(interfaces, self, parent, catalog, source_id, errors);
