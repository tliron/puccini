    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    ...
    fn complete(
        ...
        complete_map!(capabilities, self, parent, catalog, source_id, errors);
        complete_tagged_values!(requirements, self, parent, catalog, source_id, errors);
        complete_map!(interfaces, self, parent, catalog, source_id, errors);
        complete_map!(artifacts, self, parent, catalog, source_id, errors);
