    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    fn complete(
        ...
        complete_map_for_field!(inputs, self, notification_definition, catalog, source_id, errors);
        complete_map_for_field!(outputs, self, notification_definition, catalog, source_id, errors);
