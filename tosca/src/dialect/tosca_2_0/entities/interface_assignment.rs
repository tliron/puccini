    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    fn complete(
        ...
        complete_map_for_field!(inputs, self, interface_definition, catalog, source_id, errors);
        complete_map_for_field!(operations, self, interface_definition, catalog, source_id, errors);
        complete_map_for_field!(notifications, self, interface_definition, catalog, source_id, errors);
