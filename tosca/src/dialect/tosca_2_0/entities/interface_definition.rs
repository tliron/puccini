    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    fn complete(
        ...
        complete_map!(inputs, self, interface_type, catalog, source_id, errors);
        complete_map!(inputs, self, parent, catalog, source_id, errors);
        complete_map!(operations, self, interface_type, catalog, source_id, errors);
        complete_map!(operations, self, parent, catalog, source_id, errors);
        complete_map!(notifications, self, interface_type, catalog, source_id, errors);
        complete_map!(notifications, self, parent, catalog, source_id, errors);
