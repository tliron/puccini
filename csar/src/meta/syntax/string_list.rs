...
/// String list to CSAR meta.
pub fn string_list_to_meta(keyname: &str, values: &Vec<String>) -> Result<Vec<String>, CsarError> {
    values.iter().map(|value| coerce_list_value(keyname, value)).collect()
}

/// String list from CSAR meta.
pub fn string_list_from_meta(keyname: &str, value: &str) -> Result<Vec<String>, CsarError> {
