...
Check out our [published binaries](https://github.com/tliron/puccini/releases) for common architectures.

These are release builds of the latest public version with all the default features.
